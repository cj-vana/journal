...
export function renderGrowthPage(records: GrowthRecordForPdf[]): string {
  const rows = records
    .map((r) => {
      const date =
      ...
      ">
        <thead>
          <tr>
            ...
            <th style="padding: 8px 12px; border-bottom: 2px solid #d4a574; text-align: center; font-size: 11px; color: #a08b7a; text-transform: uppercase; letter-spacing: 1px;">Height (cm)</th>
            <th style="padding: 8px 12px; border-bottom: 2px solid #d4a574; text-align: center; font-size: 11px; color: #a08b7a; text-transform: uppercase; letter-spacing: 1px;">Weight (kg)</th>
            <th style="padding: 8px 12px; border-bottom: 2px solid #d4a574; text-align: center; font-size: 11px; color: #a08b7a; text-transform: uppercase; letter-spacing: 1px;">Head (cm)</th>
          </tr>
        </thead>
        <tbody>${rows}</tbody>
      </table>
