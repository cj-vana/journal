...
const adminItems = [
  { href: '/guestbook', label: 'Guestbook', icon: Gift },
    ...
    >
      ...
      <div className={cn('p-4 border-b border-warm-200', collapsed && 'px-2')}>
        {!collapsed ? (
          ...
          <div className="w-10 h-10 rounded-full bg-accent-400 flex items-center justify-center text-white font-accent text-lg mx-auto">
            {appTitle.charAt(0)}
          </div>
        )}
      </div>
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? 'bg-accent-50 text-accent-600 border-r-2 border-accent-400'
