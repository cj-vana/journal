      ...
      >
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="text-warm-600 hover:text-warm-600 transition-colors p-1 rounded-lg hover:bg-warm-50 focus-visible:ring-2 focus-visible:ring-rose-400 focus-visible:ring-offset-2"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
