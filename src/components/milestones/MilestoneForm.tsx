    ...
    >
      ...
      <div className="mb-4">
        ...
        <input
          ...
          required
          className="w-full px-3 py-2 rounded-xl border border-warm-200 text-warm-800 text-sm focus:outline-none focus:ring-2 focus:ring-accent-400"
        />
      </div>
      ...
      <div className="mb-4">
        ...
        <textarea
          ...
          rows={3}
          className="w-full px-3 py-2 rounded-xl border border-warm-200 text-warm-800 text-sm focus:outline-none focus:ring-2 focus:ring-accent-400 resize-none"
        />
      </div>
      ...
      <div className="flex gap-3 justify-end">
        ...
        <button
          ...
          className="px-6 py-2 rounded-xl text-sm font-medium bg-accent-400 text-white hover:bg-accent-600 disabled:opacity-50 transition-colors"
        >
