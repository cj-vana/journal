  ...
  return (
    <div
      className={
        ...
        'prose-blockquote:border-l-4 prose-blockquote:border-accent-200 prose-blockquote:pl-4 prose-blockquote:italic prose-blockquote:text-warm-600 ' +
      ...
      dangerouslySetInnerHTML={{ __html: sanitizeHtml(html).replace(/<img(?![^>]*loading=)/gi, '<img loading="lazy" ') }}
    />
  )
}
