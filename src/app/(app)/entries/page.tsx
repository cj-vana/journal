  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <Link
          href="/entries/new"
          className="flex items-center gap-2 px-4 py-2 bg-rose-400 text-white rounded-xl hover:bg-rose-600 transition-colors font-medium text-sm"
        >
          <Plus size={18} />
          <span>New Entry</span>
        </Link>
        ...
        <>
          ...
          {totalPages > 1 && (
            <div className="flex justify-center gap-2 mt-8">
              {page > 1 && (
                <Link
                  href={`/entries?page=${page - 1}&search=${search}&tagId=${tagId}&sort=${sort}`}
